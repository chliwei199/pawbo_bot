...
class ImagemapHandler {
	...
	public function createImagemap() {
        $columns = array();
        $baseUrl='https://'. $_SERVER['HTTP_HOST'].getenv('image_path').'menu_pawbo.png?_ignore=';
        $altText="FAQ清單";
        
        $baseSizeBuilder = new BaseSizeBuilder(800,1040);
        $areaBuilder1_1 = new AreaBuilder(40,196,204,108); 	
        ...
        $columns[] = new ImagemapMessageActionBuilder($faq_1_1,$areaBuilder1_1);
